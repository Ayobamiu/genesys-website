...
class ProductDesigners extends Component {
  ...
  render() {
    return (
      <div className="learnable-product-designer">
        <section className="learnable-product-designer-section-learnable-software-developer">
          <div className="learnable-product-designer-section-learnable-software-developer--text">
            <h1 className="learnable-product-designer-section-learnable-software-developer--text--head">
              The Learnable Product Designer
            </h1>
            <p className="learnable-product-designer-section-learnable-software-developer--text--para">
          ...
          <div className="learnable-product-designer-section-learnable-software-developer--media">
            <img
              className="learnable-product-designer-section-learnable-software-developer--media--image"
              src={pic_1}
              alt=""
            />
          </div>
        </section>
        <section className="learnable-product-designer-section-someone-to-count-on">
          <h1 className="learnable-product-designer-section-someone-to-count-on--text">
            “ The greats weren t great because at birth they could paint. The
            greats were great because they painted a lot.” <br /> - Macklemore
          </h1>
        </section>
        <section className="learnable-product-designer-computer-section-image">
          <img
            src={pic_2}
            alt=""
            className="learnable-product-designer-computer-section-image--image"
          />
        </section>
        <section className="learnable-product-designer-section-we-expect-you-to">
          <h1 className="learnable-product-designer-section-we-expect-you-to--head">
            We expect you to…
          </h1>
          <p className="learnable-product-designer-section-we-expect-you-to--para">
          ...
          <small className="learnable-product-designer-section-we-expect-you-to--small">
            {" "}
            <br />
